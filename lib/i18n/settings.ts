export const settingsHiIN = {
  settings: {
    ...
    agentNames: {
      'default-1': 'AI शिक्षक',
      'default-2': 'AI सहायक',
      'default-3': 'क्लास क्लाउन',
      'default-4': 'जिज्ञासु मन',
      'default-5': 'नोट टेकर',
      'default-6': 'गहन विचारक',
    },
    agentRoles: {
      teacher: 'शिक्षक',
      assistant: 'सहायक',
    ...
    agentDescriptions: {
      'default-1': 'मुख्य शिक्षक, स्पष्ट और व्यवस्थित तरीके से ज्ञान समझाते हैं',
      'default-2': 'सहायक शिक्षक, छात्रों को मुख्य बिंदु समझने में मदद करते हैं',
      'default-3': 'माहौल को जीवंत बनाता है, हास्य से कक्षा को मज़ेदार बनाता है',
      'default-4': 'जिज्ञासा से भरपूर, हमेशा "क्यों" पूछता है',
      'default-5': 'ध्यान से नोट्स लेता है, मुख्य बिंदुओं को व्यवस्थित करता है',
      'default-6': 'गहराई से सोचता है, समस्याओं के मूल को समझना पसंद करता है',
    },
    close: 'बंद करें',
    save: 'सेव करें',
    // Provider settings
