...
export const TTS_PROVIDERS: Record<TTSProviderId, TTSProviderConfig> = {
  ...
  'elevenlabs-tts': {
    ...
    voices: [
      { id: 'EXAVITQu4vr4xnSDxMaL', name: 'Sarah', language: 'en', gender: 'female', description: 'voiceSarah' },
      { id: 'JBFqnCBsd6RMkjVDRZzb', name: 'George', language: 'en', gender: 'male', description: 'voiceGeorge' },
      { id: 'pNInz6obpgDQGcFmaJgB', name: 'Adam', language: 'en', gender: 'male', description: 'voiceAdam' },
      { id: 'XrExE9yKIg1WjnnlVkGX', name: 'Matilda', language: 'en', gender: 'female', description: 'voiceMatilda' },
      { id: 'nPczCjzI2devNBz1zQrb', name: 'Brian', language: 'en', gender: 'male', description: 'voiceBrian' },
      { id: 'Xb7hH8MSUJpSbSDYk0k2', name: 'Alice', language: 'en', gender: 'female', description: 'voiceAlice' },
      { id: 'onwK4e9ZLuTAKqWW03F9', name: 'Daniel', language: 'en', gender: 'male', description: 'voiceDaniel' },
      { id: 'cgSgspJ2msm6clMCkdW9', name: 'Jessica', language: 'en', gender: 'female', description: 'voiceJessica' },
    ],
