...
### Kaksh Platform Technical Constraints
...
- **Language in images**: If the image contains text, labels, or annotations, the prompt MUST explicitly specify that all text in the image should be in the course language. For purely visual images without text, language does not matter.
